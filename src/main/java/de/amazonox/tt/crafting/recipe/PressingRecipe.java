package de.amazonox.tt.crafting.recipe;

import com.google.gson.JsonObject;
import de.amazonox.tt.setup.ModRecipes;
...
public class PressingRecipe extends SingleItemRecipe {
    public PressingRecipe(
                          ResourceLocation recipeId,
                          Ingredient ingredient,
                          ItemStack result) {
        super(ModRecipes.Types.PRESSING, ModRecipes.Serializers.PRESSING.get(), recipeId, "group", ingredient, result); }
